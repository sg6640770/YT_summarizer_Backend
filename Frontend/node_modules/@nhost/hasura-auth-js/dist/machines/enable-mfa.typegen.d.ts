export interface Typegen0 {
    ...
    internalEvents: {
        ...
        'error.platform.activate': {
            type: 'error.platform.activate';
            data: unknown;
        };
        'error.platform.disable': {
            type: 'error.platform.disable';
            data: unknown;
        };
        'error.platform.generate': {
            type: 'error.platform.generate';
            data: unknown;
        };
        'xstate.init': {
            type: 'xstate.init';
    ...
    matchesStates: 'disabling' | 'generated' | 'generated.activated' | 'generated.activating' | 'generated.idle' | 'generated.idle.error' | 'generated.idle.idle' | 'generating' | 'idle' | 'idle.disabled' | 'idle.error' | 'idle.initial' | {
        generated?: 'activated' | 'activating' | 'idle' | {
            idle?: 'error' | 'idle';
        };
...
//# sourceMappingURL=enable-mfa.typegen.d.ts.map