...
export declare const signInMfaTotpPromise: (interpreter: import('xstate').Interpreter<import('../machines').AuthContext, any, {
    type: "SESSION_UPDATE";
    data: {
...
}>>, otp: string, ticket?: string) => Promise<SignInMfaTotpHandlerResult>;
