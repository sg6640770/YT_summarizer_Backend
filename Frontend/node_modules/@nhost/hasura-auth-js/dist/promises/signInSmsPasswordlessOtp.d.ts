...
export declare const signInSmsPasswordlessOtpPromise: (interpreter: import('xstate').Interpreter<import('../machines').AuthContext, any, {
    type: "SESSION_UPDATE";
    data: {
...
}>>, phoneNumber: string, otp: string) => Promise<SignInSmsPasswordlessOtpHandlerResult>;
